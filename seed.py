...
- Promotes ADMIN_EMAIL (env var) to admin, creating the user if needed.
...
from app.models import FaqItem, Page, Quote, User
...
STARTER_FAQS = [
    ...
    ("Do I need an account here to buy?",
     ...
     "streaks, and saved quotes \u2014 it's free and passwordless.", 1),
